package com.pe.auth.jwt.authorization.jwtFilter;
...
public class JwtFilter extends GenericFilterBean {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if ("OPTIONS".equals(httpServletRequest.getMethod())) {
			((HttpServletResponse) httpServletRequest).setStatus(HttpServletResponse.SC_OK);
			...
			final Claims claims = Jwts.parser().setSigningKey("uniquekey").parseClaimsJws(token).getBody();
